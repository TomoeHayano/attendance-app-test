    ...
    <main class="register-page" aria-labelledby="page-title">
        <section class="register-stage" role="region" aria-label="会員登録フォーム領域">
            ...
            <form class="reg-form" action="{{ route('register.post') }}" method="post" novalidate>
                ...
                @error('name')
                    <p class="form-error err-name">{{ $message }}</p>
                @enderror
                ...
                @error('email')
                    <p class="form-error err-email">{{ $message }}</p>
                @enderror
                ...
                @error('password')
                    <p class="form-error err-password">{{ $message }}</p>
                @enderror
                ...
                @error('password_confirmation')
                    <p class="form-error err-password-confirm">{{ $message }}</p>
                @enderror
