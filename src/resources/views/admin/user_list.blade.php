        ...
        <div class="attendance-list__inner">
            ...
            <section class="attendance-list__month-bar" aria-label="月選択エリア">
                <div class="attendance-list__month-inner">
                    {{-- 前月ボタン --}}
                    <a href="{{ url('/admin/attendance/staff/' . $user->id . '?year=' . $prevMonthDate->year . '&month=' . $prevMonthDate->month) }}"
                    ...
                    {{-- 翌月ボタン --}}
                    <a href="{{ url('/admin/attendance/staff/' . $user->id . '?year=' . $nextMonthDate->year . '&month=' . $nextMonthDate->month) }}"
            ...
            <section class="attendance-list__card" aria-label="月次勤怠一覧">
                ...
                <div class="attendance-list__csv-wrap">
                    <form
                        method="get"
                        action="{{ url('/admin/attendance/staff/' . $user->id . '/csv') }}">
