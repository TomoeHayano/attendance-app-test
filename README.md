...
- 一般ユーザー未打刻時に勤怠詳細画面で打刻入力できてよいとお聞きしています。<br>
また、未来日もしくは未来日で打刻がない日には「詳細ボタン」を非表示でお聞いております。<br>
- Figmaにメール認証画面がないためメール認証誘導画面と同一でよいとお聞きしています。
- 同一ブラウザでの管理者画面と一般ユーザー画面の同時ログインは考慮しておりません。

## テスト実行方法
- このプロジェクトでは、LaravelのFeatureテストを実装しています。<br>
